        ...
        <div className="flex space-x-4 overflow-x-auto pb-2">
          <div className="flex-shrink-0 w-80">
            <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
              <div className="mb-2">
                <span className="inline-block bg-green-100 text-green-800 text-xs font-medium px-2 py-1 rounded">10/21/2021</span>
              </div>
              <h3 className="text-base font-semibold text-gray-900 leading-tight">Updated ARP Resource Guide Explains Impact On Individual Clients</h3>
            </div>
          </div>
          <div className="flex-shrink-0 w-80">
            <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
