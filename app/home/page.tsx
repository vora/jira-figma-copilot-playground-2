    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-blue-600 text-sm font-medium">View All Clients</button>
        </div>
      ...
      <div className="px-4 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="text-blue-600 text-sm font-medium">More News</button>
        </div>
        <div className="flex space-x-4 overflow-x-auto pb-2">
          <div className="flex-shrink-0 w-80">
            <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
              <div className="bg-green-100 text-green-800 text-xs font-medium px-2 py-1 rounded mb-3 inline-block">
                10/21/2021
              </div>
