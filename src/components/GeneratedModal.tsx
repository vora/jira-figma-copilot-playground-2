...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  const getButtonClasses = (variant: string, isSecondary = false) => {
    ...
    if (isSecondary) {
      return `${baseClasses} bg-gray-100 text-gray-700 hover:bg-gray-200 focus:ring-gray-500 border border-gray-300`;
    }
