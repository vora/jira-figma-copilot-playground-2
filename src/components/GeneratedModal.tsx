...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  const secondaryButtonClasses = 'px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 bg-gray-100 hover:bg-gray-200 text-gray-900 focus:ring-gray-500';
